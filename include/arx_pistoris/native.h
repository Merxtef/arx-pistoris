...
ARX_API ArxReturnCode arx_pistoris_amb_to_json(const ArxAmb* amb, uint32_t pretty, char** out_json) ARX_NOEXCEPT;
ARX_API ArxReturnCode arx_pistoris_amb_from_json(const uint8_t* data, size_t size, ArxAmb** out_amb) ARX_NOEXCEPT;
...
ARX_API ArxReturnCode arx_pistoris_ftl_to_json(const ArxFtl* ftl, uint32_t pretty, char** out_json) ARX_NOEXCEPT;
ARX_API ArxReturnCode arx_pistoris_ftl_from_json(const uint8_t* data, size_t size, ArxFtl** out_ftl) ARX_NOEXCEPT;
...
ARX_API ArxReturnCode arx_pistoris_tea_to_json(const ArxTea* tea, uint32_t pretty, char** out_json) ARX_NOEXCEPT;
ARX_API ArxReturnCode arx_pistoris_tea_from_json(const uint8_t* data, size_t size, ArxTea** out_tea) ARX_NOEXCEPT;
