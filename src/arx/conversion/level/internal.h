...
struct NativeBuildWarnings {
  ...
  std::uint64_t renamed_duplicate_portals = 0;
  std::uint64_t renamed_duplicate_lights = 0;
  std::uint64_t renamed_duplicate_fogs = 0;
  std::uint64_t renamed_duplicate_zones = 0;
  std::uint64_t renamed_duplicate_paths = 0;
